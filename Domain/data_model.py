...
from Domain.intent_parser import parse_query
# from Domain.data_loader import load_data
from Domain.data_filter import sort_by, apply_filter
...
class DataModel:
    ...
    #     """
    #     try:
    #         self.df = load_data(file_path)  # Call function from data_loader.py
    ...
    def sort_by(self, column: str, ascending: bool = True) -> pd.DataFrame:
        ...
        self.filtered_df = sort_by(self.filtered_df, column, ascending)  # Call function from data_filter.py
    ...
    def clear_filter(self):
        """
        Resets the filtered DataFrame to the original DataFrame, effectively clearing any applied filters.
        """
        if self.df is None:
            raise ValueError("No data loaded")
        self.filtered_df = self.df.copy()
    ...
    def apply_filter(self, column: str, filter_type: str, value) -> pd.DataFrame:
        ...
        self.filtered_df = apply_filter(self.filtered_df, column, filter_type, value)
        return self.filtered_df
